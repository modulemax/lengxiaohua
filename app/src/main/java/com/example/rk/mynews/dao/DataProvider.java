...
public class DataProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.rk.mynews.provider";
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY, "joke", FEEDS);
    }
    ...
    public static MySQliteOpenHelper getDBHelper() {
        if (mDBHelper == null) {
            mDBHelper = new MySQliteOpenHelper(MyApplication.getContext(),"hello",null,1 );
        }
        return mDBHelper;
    }
